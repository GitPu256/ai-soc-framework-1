...
Shows telemetry flow from ingestion → normalization → feature extraction → detection → explainability → governance → audit logging.
 Data Flow Diagram
 <img width="975" height="650" alt="image" src="https://github.com/user-attachments/assets/20566f49-334a-4b74-91ef-4f731b5982e5" />
...
UML Use Case Diagram
 <img width="975" height="650" alt="image" src="https://github.com/user-attachments/assets/896dc003-ffd7-47b2-8e4f-22b12abfdf0c" />
...
Entity Relationship Diagram
 <img width="1050" height="524" alt="image" src="https://github.com/user-attachments/assets/fc57b643-918d-4ba7-a71e-ea3e2b7e8cac" />
