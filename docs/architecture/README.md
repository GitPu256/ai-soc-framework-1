...
Conceptual model of the AI Enabled SOC Architecture showing ingestion, detection, explainability, and governance layers.
This folder contains system architecture documentation for the AI-Driven SOC Framework.
<img width="975" height="822" alt="image" src="https://github.com/user-attachments/assets/3a800d82-64e3-494e-9989-7e894a0bb8f5" />
...
Shows telemetry flow from ingestion → normalization → feature extraction → detection → explainability → governance → audit logging.
 Data Flow Diagram
 <img width="975" height="650" alt="image" src="https://github.com/user-attachments/assets/b0c7a018-b7e1-4acc-a205-403fe3f017b9" />

Figure 4. Data flow diagram showing end to end SOC processing pipeline.
3.4.2 UML Use Case Diagram
<img width="975" height="650" alt="image" src="https://github.com/user-attachments/assets/53db415c-fc3c-4e2b-96eb-af7510c3293c" />
...
<img width="1050" height="524" alt="image" src="https://github.com/user-attachments/assets/394a7107-9aad-40f4-9b18-05d787b719b3" />
